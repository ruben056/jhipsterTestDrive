...
angular.module('jhipstertemplateApp')
    .config(function ($stateProvider) {
        $stateProvider
            ...
            .state('timesheet.fullview', {
                parent: 'entity',
                url: '/timesheet-fullview/{id}',
                data: {
                    authorities: ['ROLE_USER'],
                    pageTitle: 'Timesheet'
                },
                views: {
                    'content@': {
                        templateUrl: 'scripts/app/entities/timesheet/timesheet-fullview.html',
                        controller: 'TimesheetFullViewController'
                    }
                },
                resolve: {
                    entity: ['$stateParams', 'Timesheet', function($stateParams, Timesheet) {
