        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('jhipstertemplateApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-jhipstertemplateApp-error');
                                var entityKey = httpResponse.headers('X-jhipstertemplateApp-params');
                                if (errorHeader) {
