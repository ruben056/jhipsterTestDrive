...
import be.rds.com.repository.AuthorRepository;
...
public class AuthorResourceIntTest {
    ...
    private static final LocalDate DEFAULT_BIRHT_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_BIRHT_DATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public void initTest() {
        ...
        author.setBirhtDate(DEFAULT_BIRHT_DATE);
    }
    ...
    public void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getBirhtDate()).isEqualTo(DEFAULT_BIRHT_DATE);
    }
    ...
    public void getAllAuthors() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].birhtDate").value(hasItem(DEFAULT_BIRHT_DATE.toString())));
    }
    ...
    public void getAuthor() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors/{id}", author.getId()))
            ...
            .andExpect(jsonPath("$.birhtDate").value(DEFAULT_BIRHT_DATE.toString()));
    }
    ...
    public void updateAuthor() throws Exception {
        ...
        author.setBirhtDate(UPDATED_BIRHT_DATE);
        ...
        assertThat(testAuthor.getBirhtDate()).isEqualTo(UPDATED_BIRHT_DATE);
    }
